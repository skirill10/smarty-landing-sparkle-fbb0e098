...
const seeds: Seed[] = [
  {
    ...
    featured: true,
    extras: [
      { label: "Mobile — Vodafone", prefix: "+49 172", price: 0.07, type: "mobile" },
      { label: "Mobile — Telekom", prefix: "+49 151", price: 0.065, type: "mobile" },
      { label: "Berlin landline", prefix: "+49 30", price: 0.028, type: "landline" },
    ],
  },
  {
    name: "United Kingdom",
    ...
    featured: true,
    extras: [
      { label: "London landline", prefix: "+44 20", price: 0.018, type: "landline" },
      { label: "Mobile — EE", prefix: "+44 74", price: 0.055, type: "mobile" },
    ],
  },
  {
    name: "France",
    ...
    trunkPrefix: "0",
    featured: true,
    extras: [{ label: "Paris landline", prefix: "+33 1", price: 0.022, type: "landline" }],
  },
  {
    name: "Spain",
    slug: "spain",
  ...
  },
  {
    ...
    featured: true,
    extras: [
      { label: "Alaska landline", prefix: "+1 907", price: 0.03, type: "landline" },
      { label: "Hawaii landline", prefix: "+1 808", price: 0.025, type: "landline" },
    ],
  },
  {
    name: "Canada",
  ...
  },
  {
    ...
    sms: 0.06,
    interval: 60,
    extras: [{ label: "São Paulo landline", prefix: "+55 11", price: 0.03, type: "landline" }],
  },
  {
    name: "Argentina",
    slug: "argentina",
...
export const mockRatesPageContent: RatesPageContent = {
  ...
  ctaDescription: "Start using Smartytel for business calls, messaging and team communication.",
