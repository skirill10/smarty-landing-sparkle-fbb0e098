...
const TIMEZONE_COUNTRY: Record<string, string> = {
  ...
  "Europe/London": "GB", "Europe/Dublin": "IE", "Europe/Zurich": "CH",
  "Europe/Warsaw": "PL", "Europe/Stockholm": "SE", "Europe/Oslo": "NO",
  "Europe/Copenhagen": "DK", "Europe/Prague": "CZ", "Europe/Bucharest": "RO",
  "Europe/Berlin": "DE", "Europe/Paris": "FR", "Europe/Madrid": "ES",
  "Europe/Rome": "IT", "Europe/Amsterdam": "NL", "Europe/Brussels": "BE",
  "Europe/Vienna": "AT", "Europe/Lisbon": "PT", "Europe/Helsinki": "FI",
 ...
 */
export function detectCurrency(): { currency: CurrencyCode; source: "saved" | "location" | "default" } {
