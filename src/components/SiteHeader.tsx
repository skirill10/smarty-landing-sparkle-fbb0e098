    ...
    groups: [
      {
        ...
        items: [
          ...
          { label: "Voicemail generator", to: "/voicemail-generator" },
          { label: "Number generator", to: "/number-generator" },
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Smartytel Academy", to: "/academy" },
          { label: "Developer docs", to: "/docs" },
          { label: "What's new", to: "/whats-new" },
          { label: "Downloads", to: "/downloads" },
          { label: "Port your number", to: "/port-your-number" },
          { label: "Carrier registration", to: "/carrier-registration" },
